...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/11 22:31:18 by yyaniv            #+#    #+#             */
/*   Updated: 2024/11/12 12:46:11 by yyaniv           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_game	init_game(int paths_c, char **paths_v)
{
	...
	game.window = mlx_new_window(game.mlx, game.levels_v[0].size.w * IMG_SIZE,
			game.levels_v[0].size.h * IMG_SIZE, "Level 1");
...
void	next_level(t_game *game)
{
	...
	{
		ft_printf("VICTORY - You conquered the dungeon!\n");
